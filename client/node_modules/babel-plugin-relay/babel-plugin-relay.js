...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RelayQLDirective = function () {
	  function RelayQLDirective(context, ast) {
	    ...
	    var schemaDirective = directiveName === __webpack_require__(10).GraphQLRelayDirective.name ? __webpack_require__(10).GraphQLRelayDirective : context.schema.getDirective(directiveName);
	    if (!schemaDirective) {
	  ...
	  if (mainDefinition.kind === 'FragmentDefinition') {
	    ...
	    try {
	      for (var _iterator = ast.definitions[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        ...
	        var _getFragmentNameParts = __webpack_require__(11)(definition.name.value),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function createRelayQLTemplate(t, path, node, state) {
	  ...
	  var _getFragmentNameParts = __webpack_require__(11)(node.name.value),
	...
	function createSubstitutionsForFragmentSpreads(t, path, fragments) {
	  return Object.keys(fragments).map(function (varName) {
	    ...
	    var _getFragmentNameParts2 = __webpack_require__(11)(fragment.name),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getRelativeImportPath(state, artifactDirectory, fileToRequire) {
	  !(state.file != null) ?  true ? __webpack_require__(4)(false, 'babel state file is null') : require('./invariant')(false) : void 0;
	  var filename = state.file.opts.filename;

	  var relative = __webpack_require__(8).relative(__webpack_require__(8).dirname(filename), __webpack_require__(8).resolve(artifactDirectory));

	  var relativeReference = relative.length === 0 || !relative.startsWith('.') ? './' : '';

	  return relativeReference + __webpack_require__(8).join(relative, fileToRequire);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function getDocumentName(path, state) {
	  ...
	  if (!documentName) {
	    ...
	    var basename = state.file && __webpack_require__(8).basename(state.file.opts.filename);
	...
	function getSchemaIntrospection(schemaPath, basePath) {
	  try {
	    ...
	    if (!__webpack_require__(16).existsSync(fullSchemaPath) && basePath) {
	      fullSchemaPath = __webpack_require__(8).join(basePath, schemaPath);
	    }
	    var source = __webpack_require__(16).readFileSync(fullSchemaPath, 'utf8');
	    if (source[0] === '{') {
	      return JSON.parse(source);
	    }
	    return __webpack_require__(1).parse(__webpack_require__(10).SCHEMA_EXTENSION + '\n' + source);
	  } catch (error) {
